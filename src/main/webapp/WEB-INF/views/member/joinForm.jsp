...
<script>
	...
	function inCheck() {
		...
		if (bCheck == false) {
			$('#birthdMessage').html('생일 확인 하세요 ~~');
			$('#birthd').focus();
		}
		if (iCheck == true && pCheck == true && repCheck == true
				&& nCheck == true && nickCheck == true && eCheck == true
				&& bCheck == true) {
			return true;
		} else
			return false;
...
<body>
	...
	<form action="insert" method="post">
		...
		<p>STing</p>
		<h2>
			운동 파트너를 찾고 있다면 <br>가입하세요.
		</h2>
		<div class="form_all">
			<div class="form_group">
				<input type="text" name="id" id="id" class="input_height"
					placeholder="ID" required> <input type="button"
					value="중복확인" id="idDup" onclick="idDupCheck()">
				<div id="idMessage" class="message"></div>
			</div>

			<div class="form_group">
				<input type="password" name="password" id="password"
					class="input_height" placeholder="password" required>
				<div id="pwMessage" class="message"></div>
			</div>

			<div class="form_group">
				<input type="password" name="repassword" id="repassword"
					class="input_height" placeholder="password 확인" required>
				<div id="repwMessage" class="message"></div>
			</div>

			<div class="form_group">
				<input type="text" name="name" id="name" class="input_height"
			...
			<div class="form_group">
				<input type="text" name="nickname" id="nickname"
					class="input_height" placeholder="닉네임" required>
				<div id="nickMessage" class="message"></div>
			</div>

			<div class="form_group">
				<input type="email" name="email" id="email" class="input_height"
					placeholder="e-mail" required>
				<div id="emailMessage" class="message"></div>
			</div>

			<div class="form_group">
				<input type="date" name="birhtd" id="birthd" class="input_height"
					required>
				<div id="birthdMessage" class="message"></div>
			</div>

			<div class="form_group">
				<input type="radio" name="gender" value="mail">남 <input
					type="radio" name="gender" value="femail">여
			</div>
		...
		<div class="btn_group">
			<br>
			<button type="submit" class="input_button" id="login_btn1"
				onclick="return incheck()">완료</button>
