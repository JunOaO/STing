...
function inCheck(){
	...
	if (iCheck==true && pCheck==true && repCheck==true && nCheck==true &&
		nickCheck==true && eCheck==true && bCheck==true ) {
		  return true;
	}else return false;
} // inCheck()	
...
<p> STing</p>
<h2>운동 파트너를 찾고 있다면 <br>가입하세요.</h2>
		<div class="form_all">
			<div class="form_group">
				<input type="text" name="id" id="id" class="input_height" placeholder="ID" required>
			...
			<div class="form_group">
				<input type="text" name="name" id="name" class="input_height" placeholder="이름" required>
			...
			<div class="form_group">
				<input type="date" name="birhtd" id="birthd" class="input_height" required>
			...
			<div class="form_group">
  				<input type="hidden" name="partyplay" value="b" >
			</div>
