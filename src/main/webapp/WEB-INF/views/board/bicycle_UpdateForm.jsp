...
<link rel="stylesheet" type="text/css" href="resources/css/sports_Update.css">
...
<body>
<form action="bicycle_Update" method="post" enctype="multipart/form-data" id="frm">
<header>
	<div id="img_wrap">
...
<div class="bord_header">
	...
	<button type="button" class="board_button" id="board_button" onclick="location.href='bicycle_Board'">자전거 게시판 </button>
	</div>
...
<input type="hidden" name="seq" value="${Detail.seq}" >
	<div class="div_title">
		...
		<input type="text" name="title" class="input_title" value="${Detail.title}" placeholder="제목입력" maxlength= 30 required>
	</div>
