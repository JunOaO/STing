...
<body>
			...
			<tr align="center" height="30px">
				...
				<td class="title_over">
					<%-- <c:if test="${logID != null}"> --%> <c:if
						test="${logID != null }">
						<a href="baseball_Detail?seq=${mm.seq}&sports=baseball">[${mm.local}][${mm.team}]&nbsp;${mm.title}&nbsp;[${mm.repleCnt}]</a>
	...
	<div align="center">
		...
		<c:if test="${pageMaker.prev && pageMaker.sPageNo>1}">
		    ...
		    <a
				href="sports${pageMaker.searchmakeQuery(pageMaker.sPageNo -1)}&sports=baseball">이전</a>&nbsp;
      </c:if>
		...
		<c:if test="${pageMaker.next && pageMaker.ePageNo >0}">
			<a
				href="sports${pageMaker.searchmakeQuery(pageMaker.ePageNo+1)}&sports=baseball">&nbsp;다음</a>&nbsp;
		<a
				href="sports${pageMaker.searchmakeQuery(pageMaker.lastPageNo)}&sports=baseball">마지막</a>
		</c:if>
	</div>
