...
<link rel="stylesheet" type="text/css" href="resources/css/baseball_InsertForm.css">
...
<body>
<form action="basebalinsert" method="post" enctype="multipart/form-data" id="frm">
...
<div class="board_all">
	<div class="div_title">
		...
		<input type="text" name="title" id="" class="input_title" value="" placeholder="제목입력" maxlength= 30 required>
	</div>
	...
	<div class="div_content">
		...
		<textarea name="content" id="smarteditor" class="input_content" placeholder="내용입력" maxlength="2048" style="resize: none; overflow-y:scroll;" required></textarea>
	</div>
