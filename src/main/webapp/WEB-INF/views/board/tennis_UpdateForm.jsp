...
<body>
<form action="tennis_Update" method="post" enctype="multipart/form-data" id="frm">
<header>
	<div id="img_wrap">
...
<div class="bord_header">
	...
	<button type="button" class="board_button" id="board_button" onclick="location.href='tennis_Board'">테니스 게시판 </button>
	</div>
