...
<body>
<form action="football_Update" method="post" enctype="multipart/form-data" id="frm">
<header>
	<div id="img_wrap">
...
<div class="bord_header">
	...
	<button type="button" class="board_button" id="board_button" onclick="location.href='football_Board'">축구 게시판 </button>
	</div>
