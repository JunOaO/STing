...
<body>
	...
	<div align="center">
		...
		<c:if test="${pageMaker.prev && pageMaker.sPageNo>1}">
		    ...
		    <a
				href="sports${pageMaker.searchmakeQuery(pageMaker.sPageNo -1)}&sports=basketball">이전</a>&nbsp;
      </c:if>
		...
		<c:if test="${pageMaker.next && pageMaker.ePageNo >0}">
			<a
				href="sports${pageMaker.searchmakeQuery(pageMaker.ePageNo+1)}&sports=basketball">&nbsp;다음</a>&nbsp;
		<a
				href="sports${pageMaker.searchmakeQuery(pageMaker.lastPageNo)}&sports=basketball">마지막</a>
		</c:if>
	</div>
